...
2021.1.09 by 退休人员紫红，重构，去掉cv2和numpy依赖
...
仅在windows环境下测试可行，mac不保证能运行（因为似乎涉及到了系统字体，字体比较容易出问题 :(
...
## 使用方法
1. 让队员们按照`姓名-性别-声部-院系-学号-入队年份`的命名方式交上 **竖版人像居中** 的类似证件照的照片，如`xxx-男-打x声部-xxxx学院-201xxxxxxx-201x.jpg`。尺寸没有严格要求，纵横比约为377:307即可。
...
> 3. 尺寸以【307*377】像素为佳，只要保持近似的纵横比即可~
> 
> ……结尾略……
